...
def tsne_plot_cluster(senses, vectors, top_k: int = 30, png_path: str = None):
    ...
    _tsne_plot_similar_words(
        senses, embedding_clusters_2d, word_clusters, 0.7, png_path
    )
...
def plot(words: List[str], path_embeddings: str, png_path: str):
    """
    ...
    tsne_plot_cluster(words, vectors, png_path=png_path)
